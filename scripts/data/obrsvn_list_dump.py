...
for attempt in range(max_retries):
    try:
        ...
        tobsrvn_df = pd.read_sql('SELECT crtr_yr, frmlnd_addr, brdt, mbl_telno, home_telno, dpst_actno, korn_flnm, exmn_psblty_yn FROM tobsrvn_exmn_lst', source_engine)
...
obsrvn_df = pd.DataFrame({
    ...
    'frmhs_nm': tobsrvn_df['korn_flnm'].fillna('Unknown'),  # frmhs_nm에 korn_flnm 매핑, None인 경우 "Unknown"으로 대체
